  ...
  return (<>
    ...
    <Slide direction="up" in={logChecked} mountOnEnter unmountOnExit className="info-input-container">
      <Grid container direction="column" alignItems="center" justify="center" gap="10px" marginTop="10px">
        <TextField error={logEmailError} type="email" helperText={logEmailError?"Invalid email":""} id="emailLog" label="email" className='info-input' onChange={(e) => { setPassword(e.target.value);validateEmail(e); }}/>
    ...
    <Slide direction="up" in={regChecked} mountOnEnter unmountOnExit className="info-input-container">
      <Grid container direction="column" alignItems="center" justify="center" gap="10px" marginTop="10px">
        <TextField id="emailReg" error={emailError} helperText={emailError ? "Invalid email" : ""} type="email" label="email" className='email-input' onChange={(e) => { setEmail(e.target.value);validateEmail(e); }} />
        ...
        <TextField id="cfPasswordReg" error={passwordError} helperText={passwordError ? "Doesn't match" : ""}type="password" label="confirm password" className='info-input' onChange={(e) => { setCfPassword(e.target.value);validatePassword(e);}} />
